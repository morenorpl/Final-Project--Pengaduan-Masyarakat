...
$query = "SELECT * FROM kritik_pelanggan";
$kumpulan_kritik = get_data($query);
// var_dump($kumpulan_kritik);
// die();
?>
...
<head>
    ...
    <title>Daftar Kritik & Saran Client</title>
</head>

<body>

    <!-- <div class="flex justify-center items-center h-auto max-w-6xl mx-auto my-20">
        <h1 class="text-white text-5xl font-semibold font-[poppins]">Kritik & Saran Clients.</h1>
    </div> -->
        ...
        <div class="flex-grow text-gray-800">
            ...
            <main class="p-6 sm:p-10 space-y-6">
                <div
                    ...
                    <div class="mr-6">
                        <h1 class="text-4xl font-semibold mb-2">Client Report List</h1>
                        <h2 class="text-gray-600 ml-0.5">List Report: Kritik & Saran dari Para Klien</h2>
                    </div>
                ...
                <section class="grid md:grid-cols-1 xl:grid-cols-1 gap-6">
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg w-full mx-auto my-24 ">
                        <table class="w-full text-sm text-left rtl:text-right  text-gray-400">
                            ...
                            <tbody>
                                <?php if (count($kumpulan_kritik) > 0): ?>
                                    <?php foreach ($kumpulan_kritik as $sementara): ?>
                                        <tr class="bg-gray-800 border-gray-700">
                                            ...
                                            <td class="px-6 py-4">
                                                <?= $sementara["jenis_umpan_balik"] ?>
                                            </td>
                                            <td class="px-6 py-4">
                                                <?= $sementara["isi_umpan_balik"] ?>
                                            </td>
                                            <td class="px-6 py-4">
                                                <?= $sementara["tanggal"] ?>
                                            </td>
                                            <td class="px-6 py-4">
                                                <img class="w-10 h-10" src="/images/<?= $sementara["image"] ?>" alt="">
                                            </td>
                                            <td class="px-6 py-4">
                                                <a href="edit.php?action=edit&id=<?= $sementara['id_umpan_balik']; ?>" class="font-medium text-blue-500 hover:underline mr-5">Edit</a>
                                                <a href="function.php?action=delete&id=<?= $sementara['id_umpan_balik']; ?>" class="font-medium text-red-500 hover:underline mr-5">Remove</a>
                                            </td>

                                        </tr>
                                    <?php endforeach ?>
                                <?php else : ?>
                                    <td colspan="7" scope="row" class="text-center px-6 py-4 font-medium whitespace-nowrap text-white bg-gray-800">
                                        No data
                                    </td>
                                <?php endif ?>
                            </tbody>
