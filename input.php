...
<head>
    ...
    <title>Input Kritik & Saran</title>
</head>
        ...
        <div class="flex-grow text-gray-800">
            ...
            <main class="p-6 sm:p-10 space-y-6">
                <div
                    ...
                    <div class="mr-6">
                        <h1 class="text-4xl font-semibold mb-2">Create Report</h1>
                        <h2 class="text-gray-600 ml-0.5">Create Report: Membuat Sebuah Kritik & Saran</h2>
                    </div>
                        ...
                        <form action="index.php" method="POST" enctype="multipart/form-data">
                            <div class="grid gap-6 mb-6 md:grid-cols-2 max-w-6xl mx-auto my-12 ">
                                <div>
                                    ...
                                    <input name="nama" type="text" id="first_name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Input nama anda" required />
                                </div>
                                <div>
                                    <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 ">Email</label>
                                    <input name="email" type="email" id="last_name" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" placeholder="Input email anda" required />
                                </div>
                                <div class="col-span-2">
                                    ...
                                    <select name="jenis_umpan_balik" id="countries" class="bg-gray-200 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required>
                                        <option disabled selected>Tipe Message</option>
                            ...
                            <div class="mb-6 max-w-6xl mx-auto">
                                ...
                                <textarea name="isi_umpan_balik" id="message" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-200 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Tulis kritik dan saran anda disini..." required></textarea>
                            </div>
                            <div class="mb-6 max-w-6xl mx-auto">
                                <label class="block mb-2 text-sm font-medium text-gray-900 " for="file_input">Upload Image</label>
                                <input name="image" class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none" id="file_input" type="file" required>
                            </div>
                            <div class="mb-6 max-w-6xl mx-auto">
